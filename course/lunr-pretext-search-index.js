...
var ptx_lunr_docs = [
{
  ...
  "body": " What's Happening, Good People!  Differential equations help us model the world; geometry and algebra help us understand their solutions.      See visual at source as may not appear above. Vector field simulation (original credit: Andrei Kashcha): ,      Visualizing (Sohphus) Lie theory     "
},
{
  "id": "fig-vector-field",
  "level": "2",
  ...
  "number": "1",
  "title": "",
  "body": "  See visual at source as may not appear above. Vector field simulation (original credit: Andrei Kashcha): ,   "
},
{
  "id": "fig-desmos-graph",
  "level": "2",
